...
Make a formatted table of the data that you used in your analysis to include in the Data Analysis Methods section of your paper. Make sure to remove variables you don't need (for example, if you are only looking at one season, you can remove season from this table)
